      ...
      <section className="flex flex-col items-center justify-center text-center h-screen px-4">
        ...
        <button onClick={() => console.log('Clicked!')}>
          <img
            src={goButtonIcon}
            alt="Build My Agent"
            className="mt-8 w-40 md:w-40 hover:scale-105 transition-transform duration-300"
          />
        </button>
      </section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
          {[
            ...
            },
            {
              icon: lockIcon,
              title: 'Data Security',
              desc: 'Data privacy is a priority. Embagent does  not store sensitive information and follows best practices to keep your user interactions safe.',
            },
          ].map((feature, i) => (
            <div
              key={i}
            ...
            >
              ...
              <button onClick={() => setActiveModal(item.modal)} className="mt-auto pt-6">
                <img
                  ...
                  className="w-24 h-auto hover:scale-105 transition-transform duration-300 mx-auto"
                />
              </button>
            </div>
          ))}
